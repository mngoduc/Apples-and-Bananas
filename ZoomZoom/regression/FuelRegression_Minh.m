...
% %r_dot = a*Go^n
% % guess a value for [a]; solve for n
% I.a = 1e-6; 
% I.da = 1e-7;
% I.n1 = 0;
% I.n2 = 1; 
...
% I.log_Go1 = log(D1.Go);
% I.log_Go2 = log(D2.Go);
% I.log_rdot1 = log(D1.r_dot);
% I.log_rdot2 = log(D2.r_dot);
% 
% while abs(I.n1 - I.n2) > 1e-2
%     I.a = I.a + I.da;
%     I.n1 = (I.log_rdot1 - log(I.a))/I.log_Go1;
%     I.n2 = (I.log_rdot2 - log(I.a))/I.log_Go2;
%     if I.n1 > 5 || I.n2 > 5
%         disp('n is too big')
%         break
%     end
...
%attempt number 2: a_exp = rdot/Go^n;
