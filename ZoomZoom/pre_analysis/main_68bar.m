...
C.P_chamber = 68*100000;    % [Pa] combustion chamber pressure, 68 bar
...
for i = 1:length(P1.mr)
   ...
   while P1.Mt_eq < 1          %(P1.entropy(:,i) < P1.entropy_throat)
      ...
      P1.Vt_eq = sqrt(2*(P1.h_o(:,i) - enthalpy_mass(P1.gas)));
      P1.Mt_eq = P1.Vt_eq/P1.a;
   end
...
for i = 1:length(P1.mr)
   ...
   while P1.Mt_fro < 1          %(P1.entropy(:,i) < P1.entropy_throat)
      ...
      P1.a = soundspeed(P1.gas);
      P1.Vt_fro = sqrt(2*(P1.h_o(:,i) - enthalpy_mass(P1.gas)));
      P1.Mt_fro = P1.Vt_fro/P1.a;
   end
